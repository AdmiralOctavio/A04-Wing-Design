...
print('x_tail: ',x_tail)
print('x_nose: ',x_nose)
print('x_airframe_services',x_airframe_services)
print('X_LEMAC',X_LEMAC)
print('x_wing: ',x_wing_cg_absolute)
print('x_prop: ',X_LEMAC+x_prop)
print('x_nacelle: ',X_LEMAC+x_nacelle)
print('x_OEW: ',x_OEW_cg_absolute)